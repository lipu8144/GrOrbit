...
export const MENU_ITEMS = [
  { id: 1, addons: [{ label: "Extra cheese", price: 30 }, { label: "Add egg", price: 20 }], name: "Classic Veg Burger", category: "Burgers", price: 149, type: "veg", status: "active", popular: true, special: false, desc: "Crispy potato patty, lettuce & house sauce", image: "https://images.unsplash.com/photo-1550317138-10000687a72b?w=200&h=200&fit=crop&auto=format" },
  ...
  { id: 4, name: "Margherita Pizza", category: "Pizza", price: 279, type: "veg", status: "active", popular: true, special: false, portions: [{ label: "Regular", price: 279 }, { label: "Large", price: 449 }], desc: "San Marzano tomato, mozzarella & basil", image: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&h=200&fit=crop&auto=format" },
